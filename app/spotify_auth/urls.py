...
from .views import AuthenticationURL, SpotifyCallback, CheckAuthentication, CurrentSpotifyUser, LogoutSpotifyUser

urlpatterns = [
    path('login/', AuthenticationURL.as_view(), name='spotify-login'),
    path('logout/', LogoutSpotifyUser.as_view(), name='spotify-logout'),
